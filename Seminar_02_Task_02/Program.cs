...
{
int second = (number /10) % 10;                  /* Находим вторую цифру числа.*/
int third = number % 10;                         /* Находим третью цифру числа.*/
int powered = (int)Math.Pow(second,third);       /* Возводим в степень. Здесь до запятой число, которое 
                                                    возводим в степень, а после запятой число, в которое 
                                                    возводим.*/
